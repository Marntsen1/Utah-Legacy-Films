...
const Proof: React.FC = () => {
  return (
    <section className="relative py-32 bg-[#e8e2d9]/30 border-y border-[#362b24]/5 overflow-hidden">
      {/* Background Texture */}
          ...
          >
            <div className="aspect-[4/5] md:aspect-square relative rounded-2xl overflow-hidden border border-[#362b24]/10 shadow-2xl shadow-[#362b24]/15">
              ...
              <img 
                ...
                alt="Grandfather reading with grandchild" 
            ...
            {/* Play Button Overlay */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center border border-white/30 cursor-pointer group-hover:scale-110 transition-transform duration-300">
            ...
            <Reveal delay={0.3} width="100%">
              <div className="flex items-center justify-center md:justify-start gap-4 border-t border-[#362b24]/10 pt-8">
                <div className="w-14 h-14 rounded-full bg-[#85756b] overflow-hidden border-2 border-white shadow-md">
                  <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80" alt="Emily R." className="w-full h-full object-cover grayscale mix-blend-multiply" />
                </div>
